...
const TESTIMONIALS = [
  ...
  { name: "Ramesh Gupta", role: "Owner, Gupta Kirana Store", country: "🇮🇳 Lucknow", stars: 5, text: "As a kirana store owner I never thought SEO was for me. NNN AI Labs set up Google Ads at ₹89/mo and now I get 15-20 new customers a week from search alone." },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface">
          ...
          <div className="hidden lg:flex items-center gap-7 text-[0.8rem] font-bold text-dark/50">
            {["#why","#services","#pricing","#testimonials","#scanner"].map((h, i) => (
              <a key={h} href={h} className="hover:text-dark transition-colors capitalize">
                {["Why Us","Services","Pricing","Results","Free Scan"][i]}
              </a>
            ))}
          </div>
      ...
      <main className="flex-grow">
        {error && (
          <div className="max-w-2xl mx-auto mt-8 px-6 py-4 bg-rose-50 border border-rose-200 rounded-2xl text-rose-700 text-[0.875rem] font-semibold text-center flex items-center justify-center gap-2">
        ...
        {!report ? (
          <>
            ...
            <section id="why" className="py-24">
              <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-12 gap-4">
                  {/* Main dark card */}
                  <div className="col-span-12 lg:col-span-7 bg-dark rounded-[2rem] p-10 flex flex-col justify-between min-h-[360px]">
                    <div>
                      <span className="inline-block px-3.5 py-1.5 bg-neon text-dark text-[10px] font-black uppercase tracking-widest rounded-full mb-5">vs. Large Agencies Like WebFX</span>
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-8">
                      {[["Low","Competition on 50K/mo keywords","text-neon"],["₹89","Starting monthly plan","text-brand-aqua"],["5:1","Average SMB ROI","text-amber-400"]].map(([n,l,c])=>(
                        <div key={l} className="bg-white/6 rounded-xl p-4 border border-white/8">
                          ...
                          <div className="text-[10px] text-white/35 font-bold uppercase tracking-wider">{l}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* Transparent pricing */}
                  <div className="col-span-12 lg:col-span-5 bg-neon/12 border-2 border-neon/25 rounded-[2rem] p-9 space-y-4">
                    ...
                    <a href={EMAIL} className="inline-flex items-center gap-2 mt-2 text-[11px] font-black text-dark/60 uppercase tracking-widest hover:text-dark transition-colors">Get Free Pricing Sheet <ArrowRight className="w-3.5 h-3.5"/></a>
                  </div>
                  ...
                  {[
                    ...
                    <div key={c.title} className={cn("rounded-[2rem] p-8 space-y-3", c.col, c.bg)}>
            ...
            {/* ── SERVICES SECTION ─── */}
            <section id="services" className="py-24 bg-[#EEEAE0]">
              <div className="max-w-7xl mx-auto px-6">
                  ...
                  {SERVICES.map((s) => (
                    ...
                    >
                      ...
                      <div className="mt-4 pt-4 border-t border-dark/8">
                        <a href={EMAIL} className="text-[10px] font-black uppercase tracking-widest text-dark/40 group-hover:text-brand-indigo transition-colors flex items-center gap-1">
                ...
                <div className="mt-6 bg-dark rounded-[2rem] p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
            ...
            <section id="pricing" className="py-24">
              <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-12">
                  {BUNDLES.map((b, i) => (
                    <motion.div
                      ...
                      whileHover={{ y: -7 }}
                      className={cn(
                        "rounded-[2rem] p-9 relative overflow-hidden transition-all",
                        b.color,
                        i === 1 && "pricing-glow"
                      )}
                    >
                ...
                {/* All plans CTA */}
                <div className="text-center bg-[#EEEAE0] rounded-[2rem] p-10">
                  ...
                  <div className="flex flex-wrap justify-center gap-3">
                    <a href={EMAIL} className="px-8 py-4 bg-dark text-white font-black uppercase text-[11px] tracking-widest rounded-2xl hover:opacity-90 transition-opacity flex items-center gap-2">
            ...
            <section id="scanner" className="py-24 bg-[#EEEAE0]">
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-14">
                  ...
                  <h2 className="font-display font-black text-dark leading-[0.92] tracking-[-0.035em]" style={{fontSize:"clamp(2.2rem,4vw,3.4rem)"}}>
                    ...
                    <span className="text-brand-indigo">Powered by Gemini AI</span>
                  </h2>
            ...
            <section id="testimonials" className="py-24">
              <div className="max-w-7xl mx-auto px-6">
                ...
                {/* Trust bar */}
                <div className="mt-6 bg-dark rounded-[2rem] p-8 flex flex-col lg:flex-row items-center justify-between gap-6">
                  <div>
            ...
            <section className="py-16">
              <div className="max-w-7xl mx-auto px-6">
                <div className="bg-brand-indigo rounded-[2.5rem] p-12 lg:p-16 relative overflow-hidden text-center">
      ...
      <footer className="footer-animated text-white pt-20 pb-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 text-[11px] font-bold text-white/30">
            <span>© {new Date().getFullYear()} NNN AI Labs (NAVA NETRA NEURAL SUDARSHAN AI LABS PVT. LTD) · DPIIT Startup India · Lucknow, India</span>
            <span className="flex items-center gap-1.5">Powered by <span className="text-neon">Gemini AI</span> · Built with <span className="text-brand-pink">❤</span> for MSMEs globally</span>
          </div>
        </div>
      </footer>
